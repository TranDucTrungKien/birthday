...
let settings = {
    ...
    sequence: 'CHÚC|MỪNG|SINH|NHẬT|Di iu|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
        { image: './image/Birthday!/photo1.jpg', content: 'Gửi Di, em mang đến cho anh nhiều niềm vui và hạnh phúc! 💕' },
        { image: './image/Birthday!/photo2.jpg', content: 'Nụ cười của em là niềm vui lớn nhất của anh! ✨' },
        { image: './image/Birthday!/photo3.jpg', content: 'Em là người phụ nữ tuyệt vời nhất mà anh từng biết! 🌸' },
        { image: './image/Birthday!/photo4.jpg', content: 'Tình yêu của em là nguồn động lực lớn nhất cho anh! 💖' },
        { image: './image/Birthday!/photo5.jpg', content: 'Chúc mừng sinh nhật em, chúc em luôn hạnh phúc! 🎉' },
        { image: './image/Birthday!/photo6.jpg', content: 'Chúc em một tuổi mới tràn đầy yêu thương và niềm vui! ⭐' },
        { image: './image/Birthday!/photo7.jpg', content: 'Em xứng đáng được yêu thương và hạnh phúc như thế này! 🌈' },
        { image: './image/Birthday!/photo8.jpg', content: 'Yêu em nhìu lắm, pà chã thúi ❤️🎂' },
...
function initializeDefaultSettings() {
    window.settings = JSON.parse(JSON.stringify(settings));
    window.settings.colorTheme = window.settings.colorTheme || 'pink';
